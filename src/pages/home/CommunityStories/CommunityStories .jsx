  ...
  return (
    <section className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-6xl mx-auto px-4 text-center">
        <h2 className="md:text-4xl font-extrabold text-gray-800 mb-12">Community Stories</h2>
                ...
                <div className="bg-white p-6 rounded-2xl shadow-lg h-[300px] flex flex-col justify-between transition duration-300 hover:shadow-xl border border-gray-100">
                  ...
                  <div className="flex items-center gap-4 ">
                    ...
                    <div className="text-left">
                      <p
                        className="font-semibold md:text-lg text-gray-800 max-w-[160px]"
                  ...
                  {/* Middle: Review Text */}
                  <p
                    className="text-gray-700 text-[15px] italic mb-4 leading-relaxed relative line-clamp-5"
