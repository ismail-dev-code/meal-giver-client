      ...
      <div className="w-11/12 mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 border-b border-white/20 pb-6">
        ...
        <div>
          ...
          <p className="text-sm text-white/80">
            Reducing food waste and feeding communities — one donation at a time.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1 text-sm">
            ...
            <li><Link to="/all-donations" className="hover:underline">Browse Donations</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="flex space-x-4 text-xl">
            ...
            <a href="https://www.linkedin.com/in/ismail-hossain24" target="_blank" rel="noopener noreferrer">
