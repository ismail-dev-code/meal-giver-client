...
const statusIcons = {
  ...
  requested: <FaHandHoldingHeart className="text-4xl text-warning" />,
  picked_up: <FaCheckCircle className="text-4xl text-info" />,
  expired: <FaHourglassHalf className="text-4xl text-error" />,
};
...
export default function AdminDashboard() {
  ...
  const {
    ...
    queryKey: ["donationStatusCount"],
    queryFn: async () => {
      const res = await axiosSecure.get("/donations/status-count");
      return res.data;
    },
    staleTime: 5 * 60 * 1000,
    retry: 1,
  ...
  return (
    <div className="p-6">
      <h1 className="text-3xl font-bold mb-6">Donation Summary (Admin)</h1>
