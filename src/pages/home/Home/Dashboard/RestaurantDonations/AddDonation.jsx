  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white shadow-md rounded-lg">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        {/* Quantity */}
        <div>
          <label className="block mb-1 font-medium">Quantity (kg or portions)</label>
          <input
            type="number"
            ...
            placeholder="e.g. 10"
          />
          {errors.quantity && <p className="text-red-500 text-sm">Valid quantity required</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.pickupWindow && <p className="text-red-500 text-sm">Pickup window required</p>}
        </div>
        ...
        <div>
          ...
          />
          {errors.location && <p className="text-red-500 text-sm">Location required</p>}
        </div>
