        ...
        <ul className="menu p-4 w-64 min-h-full bg-secondary space-y-2 text-white">
          ...
          {!roleLoading && role === "user" && (
            <>
              ...
              <li>
                <NavLink to="/dashboard/charity-transactions" className="flex items-center gap-2">
          ...
          {!roleLoading && role === "restaurant" && (
            <>
              <li>
                <NavLink to="/dashboard/restaurant-profile" className="flex items-center gap-2">
          ...
          {!roleLoading && role === "charity" && (
            <>
              <li>
                <NavLink to="/dashboard/charity-profile" className="flex items-center gap-2">
          ...
          {!roleLoading && role === "admin" && (
            <>
              ...
              <li>
                <NavLink to="/dashboard/manage-role-requests" className="flex items-center gap-2">
              ...
              <li>
                <NavLink to="/dashboard/feature-donations" className="flex items-center gap-2">
                ...
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Are you sure you want to log out of your MealGiver account?
                    </p>
                  </div>
